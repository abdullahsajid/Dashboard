...
import { Button, Container, Row, Col, Form, Image, Stack } from 'react-bootstrap';
                ...
                <Col lg={4}>
                    <Stack direction='vertical' className='p-4'>
                        <Stack direction='vertical' className='mb-3'>
                            ...
                            <h5 className='heading'>Adventure starts here 🚀</h5>
                            <p className='gray'>Make your app management easy and fun!</p>
                        </Stack>
                        <Form style={{ width: "100%" }}>
                            ...
                            <Form.Group className="mb-3" controlId="formGroupEmail">
                                <Form.Label className='label--heading gray'>Email address</Form.Label>
                            ...
                            <Stack direction='horizontal'>
                                ...
                                <Form.Label className='mb-3 ms-3'>
                                    <span className='gray'>I agree to</span> <a href='#' style={{ textDecoration: "none", color: "rgb(115,103,240)" }}>privacy policy & terms</a>
                                </Form.Label>
                            </Stack>
                            <Button style={{ width: "100%", backgroundColor: "#7367F0" }}>Sign up</Button>
                        </Form>
                        <Stack direction='horizontal' className='mx-auto mt-3'>
                            <div className='gray'>Already have an account?</div>
                            <div className='ms-3 gray'><a href='#' style={{ textDecoration: "none", color: "rgb(115,103,240)" }}>Sign in instead</a></div>
                        </Stack>
